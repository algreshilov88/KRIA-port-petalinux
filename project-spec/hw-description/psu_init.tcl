...
set psu_clock_init_data {
    ...
    mask_write 0XFF180360 0x0000000F 0x00000005
    ...
    mask_write 0XFF180308 0x000000C6 0x000000C6
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01010802
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180160 0x03FFFFFF 0x03FFDFFF
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410010 0x00000077 0x00000055
		# : CHECKING PLL LOCK
    ...
    mask_write 0XFD410040 0x0000000F 0x00000000
    ...
    mask_write 0XFD410044 0x0000000F 0x00000000
